...
<body>
        ...
        <div class="formulario">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" id="formulario-login" >
                ...
                <div class="form-outline mb-4">
                 ...
                 <!-- ALERTS USUARIO NO EXISTE -->
                 <?php if(isset($mensajeRegistroFallido['vacio'])) : ?>
                ...
                <div class="contendor-boton">
                    <button type="submit" name="submit" value="inicioSession" id="submit" class="btn fw-semibold btn-block mb-4">Iniciar Sessión</button>
                </div>
    ...
    <script src="http://127.0.0.1/DAW/js/login.js"></script>
